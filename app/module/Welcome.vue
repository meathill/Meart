<template lang="pug">
  <form class="carousel slide welcome-panel" data-ride="carousel" data-interval="0" data-keyboard="false" id="welcome-wizard" @submit.prevent="onSubmit">
    <div class="carousel-inner" role="listbox">
      <div class="carousel-item" :class="currentPage === 0 ? 'active' : ''">
        <section>
          h1 欢迎使用 Meart
        ...
        <footer>
          a#welcome-wizard.btn.btn-primary.btn-lg.carousel-control(href="#", role="button", tabindex="0", @click="goNext") 开始创建网站
        </footer>
      </div>
      .carousel-item.info(:class="currentPage === 0 ? 'active' : ''")
        <fieldset>
          <legend>基本信息</legend>
          ...
          <div class="form-group">
            ...
            input#site-icon.hide(type="file", @change="onSelectFile")
      ...
      .carousel-item(:class="currentPage === 0 ? 'active' : ''")
        <fieldset>
          <legend>选择模板</legend>
